...
const fs = require("fs").promises
    ...
    const listarMetas = async () => {
        ...
        if(metas.length == 0) {
            mensagem = "Voce nao tem nenhuma meta cadastradas"
            return
        }

        const respostas = await checkbox({
            message: "Use as setas para mudar de meta, o espaço para marcar ou desmarcar e o enter para finalar essa etapa",
            choices: [...metas],
            instructions: false
        })
